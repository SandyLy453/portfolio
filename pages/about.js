...
export default function About() {
    ...
    const [bannerSound, setBannerSound] = useState(false);
    ...
    useEffect(() => {
        const observer = new IntersectionObserver(
          ([entry]) => {
            setOpacity(entry.intersectionRatio); // ratio = 0 to 1
          },
          {
    ...
    const handleBannerClick = () => {
        ...
        toggleBanner(); // call your existing toggle logic
      };      
        ...
        <main className={styles.main}>
            ...
            <div className={styles.marqueeWrapper}>
                <div className={styles.marquee}>
                    <span>Click the banner to switch to Vietnamese/ English introduction • </span>
                    <span>Nhấn vào banner để chuyển đổi giữa phần giới thiệu Tiếng Việt và Tiếng Anh • </span>
                    <span>Click the banner to switch to Vietnamese/ English introduction • </span>
                    <span>Nhấn vào banner để chuyển đổi giữa phần giới thiệu Tiếng Việt và Tiếng Anh • </span>
                </div>
            </div>

            <div className={styles.bannerBox} onClick={handleBannerClick} ref={bannerRef}>
                <Image
                ...
                />
                <div className={styles.textBox} style={{ opacity }}>
                    {!bannerToggled ? (
                    <>
