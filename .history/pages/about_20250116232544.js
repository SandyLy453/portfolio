    ...
    <>
        ...
        <main className={styles.main}>
            ...
            <div className={styles.intro}>
                ...
                <p className={styles.introText}>
                    I'm <span className={styles.name}>Boi San</span>, but feel free to call me <span className={styles.name}>Sandy</span> or <span className={styles.name}>San</span> as you prefer. I'm a Digital Designer and Front-end Web Developer who loves crafting visually engaging, user-friendly designs that bring ideas to life with a perfect mix of creativity and practicality. 
                </p>
