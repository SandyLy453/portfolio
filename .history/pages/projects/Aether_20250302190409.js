            ...
            <main className={styles.body}>
                ...
                <div className={styles.intro}>
                    ...
                    <div className={styles.topText}>
                        ...
                        <p className={styles.content}>
                            Figma, Adobe Illutrator, NextJS, React
                        </p>
                ...
                <div className={styles.video}>
                    ...
                    <div className={styles. middlee}>
                        <p className={styles.content}>
                            To resonate with caregivers and highlight the challenges they face when managing paperwork and filling out forms, this video captures the frustration and exhaustion of navigating complex documents. It then transitions into a seamless, stress-free experience with  <span className={styles.span}>Aether</span>. By simplifying the process and making essential forms more accessible, the video illustrates how Aether transforms frustration into relief, turning a daunting task into an effortless and empowering journey.
                        </p>
                    </div>
                ...
                <div className={styles.infoSection}>
                    ...
                    <div className={styles. middlee}>
                        <div className={styles.bc}>
                            <Image src={'/BC1.png'} alt="business card" className={styles.com} width={800} height={590} />
                            <Image src={'/BC2.png'} alt="business card" className={styles.com} width={800} height={590} />
                        </div>
