        ...
        <>
            ...
            <main className={styles.main}>
                ...
                <div className={styles.intro}>
                    <Image src={'/cancover.png'} alt="Can Cover" className={styles.gifOne} width={140*4} height={100*4}/>
                ...
                <Image src={'/design1.png'} alt="Can 1 dieline" className={styles.design} width={321*2} height={172*2}/>
                <Image src={'/design1.png'} alt="Can 1 dieline" className={styles.design} width={140*4} height={100*4}/>
                <Image src={'/design1.png'} alt="Can 1 dieline" className={styles.design} width={140*4} height={100*4}/>
