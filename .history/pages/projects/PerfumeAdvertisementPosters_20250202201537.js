            ...
            <main className={styles.main}>
                ...
                <div className={styles.middle}>
                    <div className={styles.text}>
                        ...
                        <p className={styles.content}>
                            The Black Organization perfume line is designed as <span className={styles.span}>Detective Conan</span> merchandise, capturing each character's essence through symbolic design. Sherry's DNA motif represents her work on experimental medicine, Scotchss phone reflects his silent yet courageous justice, and Bourbon's chain signifies his mystery and responsibility. These elements deepen the connection to the characters, making the perfumes both collectible and meaningful for <span className={styles.span}>Detective Conan</span> fans.
                        </p>
                    </div>
                </div>
