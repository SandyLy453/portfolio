        ...
        <>
            ...
            <main className={styles.main}>
                ...
                <div className={styles.showcase}>
                    <Image src={'/film1.png'} alt="Design 1" className={styles.design} width={300} height={300}/>
                    <Image src={'/film2.png'} alt="Design 2" className={styles.design} width={300} height={300}/>
                </div>
