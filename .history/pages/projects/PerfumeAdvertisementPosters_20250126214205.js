        ...
        <>
            ...
            <main className={styles.main}>
                ...
                <div className={styles.showcase}>
                    <Image src={'/post4.png'} alt="Poster 1" className={styles.design} width={330*2} height={370*2}/>
                    <Image src={'/post5.png'} alt="Poster e" className={styles.design} width={330*2} height={370*2}/>
                    <Image src={'/post6.png'} alt="Poster " className={styles.design} width={330*2} height={370*2}/>
                </div>
