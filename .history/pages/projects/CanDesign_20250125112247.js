        ...
        <>
            ...
            <main className={styles.main}>
                ...
                <div className={styles.sketchSection}>
                    <Image src={'/s1.png'} alt="Can 1 dieline" className={styles.idea} width={321*3} height={172*3}/>
                    <Image src={'/s2.png'} alt="Can 1 dieline" className={styles.idea} width={321*3} height={172*3}/>
                </div>
