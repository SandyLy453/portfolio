        ...
        <>
            ...
            <main className={styles.main}>
                ...
                <div className={styles.sketchSection}>
                    <Image src={'/s6.png'} alt="Can 1 dieline" className={styles.idea} width={330*3} height={220*3}/>
                    <Image src={'/s7.png'} alt="Can 1 dieline" className={styles.idea} width={330*3} height={220*3}/>
                </div>
