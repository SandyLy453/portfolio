        ...
        <>
            ...
            <main className={styles.main}>
                ...
                <div className={styles.showcase}>
                    ...
                    <Image src={'/post5.png'} alt="Can 1 dieline" className={styles.design} width={321*3} height={172*3}/>
                    <Image src={'/post6.png'} alt="Can 1 dieline" className={styles.design} width={321*3} height={172*3}/>
                </div>
