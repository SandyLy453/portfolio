        ...
        <>
            ...
            <main className={styles.main}>
                ...
                <div className={styles.sketchSection}>
                    <Image src={'/sketch1.png'} alt="Can 1 dieline" className={styles.idea} width={321*3} height={172*3}/>
                    <Image src={'/sketch2.png'} alt="Can 1 dieline" className={styles.idea} width={321*3} height={172*3}/>
                </div>
                ...
                <div className={styles.showcase}>
                    ...
                    <Image src={'/sketch1.png'} alt="Can 1 dieline" className={styles.design} width={321*3} height={172*3}/>
                </div>
