...
export default function Clotho() {
    ...
    const [feature, setFeature] = useState("invetory")
        ...
        <>
            ...
            <div className={styles.feature}>
                ...
                <div className={styles.toggle}>
                    ...
                    <button
                        className={feature === "calend" ? styles.active : styles.sleep}
                ...
                {feature === "inventory" && (
                    <div className={styles.box}>
                        <Image src={'/invetory.png'} alt="inventory feature" width={500} height={500} className={styles.feaImage} />
                ...
                {feature === "calender" && (
                    <div className={styles.box}>
                        <Image src={'/calender.png'} alt="calender feature" width={500} height={500} className={styles.feaImage} />
                        <p className={styles.des}>
