        ...
        <>
            ...
            <div className={styles.bookContainer}>
                    <HTMLFlipBook 
                        ...
                        startZIndex={2} // Ensures proper stacking for standalone pages
                        showCover={true} // Ensures first and last pages are standalone
                    >
                        {/* First page (standalone cover) */}
                        <div className={styles.page}>
                            <Image
                                src={`/images/maga1.png`}
                                alt="Magazine Cover"
                                width={400}
                                height={500}
                                layout="responsive"
