...
{language === "vietnamese" && (
          <div className={styles.intro}>
            ...
            <p className={styles.introText}>
              Mình là <span className={styles.lilName}>Bội San</span>, bạn cũng có thể gọi mình là <span className={styles.lilName}>Sandy</span> hoặc <span className={styles.lilName}>San</span> tùy theo bạn thích! Tôi là một Nhà Thiết Kế Kỹ Thuật Số kiêm Lập Trình Viên Front-end,yêu thích việc tạo ra các thiết kế bắt mắt, thân thiện với người dùng và mang lại sự cân bằng giữa sáng tạo và thực tiễn.
            </p>

            <p className={styles.introText}>
              Trong quá trình học ngành Digital Design and Devilopment tại BCIT, tôi đã khám phá những lĩnh vực thú vị như xây dựng thươnghiệu, tạo wireframe, phát triển front-end và cả một chút tiếp thị kỹ thuật số. Tôi luôn cố gắng tạo ra những thiết kế không chỉ đẹp mà còn có ý nghĩa, giúp giải quyết vấn đề và để lại dấu ấn tích cực.
            </p>
            <p className={styles.introText}>
              Khi không làm việc, bạn sẽ thấy tôi tham gia các dự án DIY thú vị, thử nghiệm trong bếp, hoặc thư giãn với anime, phim, hoặc Cdrama. Tôi rất thích đọc manga, manhwa, và manhua—đây là cách tôi thư giãn và khám phá các phong cách nghệ thuật độc đáo. Tôi cũng thíchtạo tranh minh họa kỹ thuật số trên Procreate—đó là nơi tôi tìmthấy niềm vui!
            </p>
            <p className={styles.introText}>
              Hãy cùng nhau tạo nên điều tuyệt vời nhé — tôi rất mong được làm việccùng bạn!
            </p>
          </div>
        )}
