...
export default function About() {
    ...
    useEffect(() => {
        ...
        const observer = new IntersectionObserver(
          ([entry]) => {
            const visibleRatio = entry.intersectionRatio; // value between 0 and 1
            textBox.style.opacity = visibleRatio.toFixed(2); // smooth fade
          },
          {
            root: null,
            threshold: Array.from({ length: 101 }, (_, i) => i / 100), // granularity 0 -> 1
          }
        );
